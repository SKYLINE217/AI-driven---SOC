...
def test_compute_windowed_features_empty():
    ...
    fv = asyncio.run(compute_windowed_features("hostA:userA:1.1.1.1", mock_redis, current_time))
...
def test_compute_windowed_features_populated():
    ...
    fv = asyncio.run(compute_windowed_features("hostB:userB:2.2.2.2", mock_redis, current_time))
