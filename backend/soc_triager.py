...
Usage: python -m backend.soc_triager <command> [options]
   or: cd backend && python soc_triager.py <command> [options]
"""
import argparse
import sys
...
def _generate_artifacts(incident: dict, output_dir: str):
    ...
    from backend.artifacts.attack_graph import generate_attack_graph
    from backend.artifacts.playbook_renderer import render_playbook
...
def cmd_evaluate(args):
    from backend.ml.evaluate import generate_synthetic_evaluation, compute_llm_metrics, generate_report
...
def cmd_generate(args):
    ...
    if args.type == "auth":
        from backend.ingestion.generators.auth_log_generator import (
        ...
        from backend.ingestion.generators.cloudtrail_generator import (
...
def cmd_list_incidents(args):
    ...
    from backend.display import print_incident_table
...
def cmd_show_incident(args):
    from backend.services.incident_service import get_incident, verify_chain
    from backend.display import print_incident_detail
    ...
    try:
        from backend.display import console
...
def cmd_update_status(args):
    from backend.services.incident_service import update_status, get_incident
    from backend.display import print_incident_detail
